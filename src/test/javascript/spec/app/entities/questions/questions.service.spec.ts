...
describe('Service Tests', () => {
    describe('Questions Service', () => {
        ...
        beforeEach(() => {
            ...
            elemDefault = new Questions(0, 'AAAAAAA', 'AAAAAAA', 'AAAAAAA', 0, 'AAAAAAA');
        });
        ...
        describe('Service methods', async () => {
            ...
            it('should create a Questions', async () => {
            ...
            it('should update a Questions', async () => {
                const returnedFromService = Object.assign(
                    {
                        name: 'BBBBBB',
                        description: 'BBBBBB',
            ...
            it('should delete a Questions', async () => {
