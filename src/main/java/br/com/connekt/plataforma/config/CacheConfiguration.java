package br.com.connekt.plataforma.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("plataforma");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("plataforma");
        ...
        config.getMapConfigs().put("br.com.connekt.plataforma.domain.*", initializeDomainMapConfig(jHipsterProperties));
